              ...
              {DATA.awards.map((award, id) => (
                ...
                >
                  <div className="flex flex-col space-y-2 p-6 border rounded-lg">
                    ...
                    {award.url && (
                      <Link href={award.url} className="text-blue-500 hover:underline text-sm">
                        Learn more →
                      </Link>
                    )}
                  </div>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                . I&apos;m always interested in discussing technology, career opportunities, and innovative projects.
              </p>
            </div>
          </BlurFade>
        </div>
